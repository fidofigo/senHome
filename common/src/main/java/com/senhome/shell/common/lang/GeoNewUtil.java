...
public class GeoNewUtil
{
     ...
     * @param polygonXY 多边形的纬度坐标集合
     * @return
     */
    public static boolean isPointInPolygon ( double px , double py , List<Double> polygonXA , Map<Double, Double> polygonXY)
    {
        ...
        for (int i = 0; i < polygonXA.size() - 1; i++)
        {
            ...
            double cy1 = polygonXY.get(cx1);
            double cx2 = polygonXA.get(i + 1);
            double cy2 = polygonXY.get(cx2);
            //如果目标点在任何一条线上
